...
<html lang="fr">
<head>
    <title>Nouvelle annonce - MBM</title>
                            ...
                            <div class="card-body">
                                ...
                                <form enctype="multipart/form-data" action="" method="post"> <!--Formulaire d'ajout d'annonce-->
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <label class="form-check-label" for="flexCheckChecked">J'accepte les conditions général d'utilisateur, les règles de diffusion du site MBM et j'autorise MBM a diffuser mon annonce.
                                        </label>
                                    </div>
                                    <input style='background-color: #19cbdf' class="btn px-5" name="btn" type="submit" value="Enregistrer">
                                </form>
