                                ...
                                <div class='card rounded hover-shadow'>
                                    <div class="card">
                                        ...
                                        <?php if(isset($uid)): ?>
                                            ...
                                            $verif->execute(array($ida, $uid));
                                            if($verif->rowCount() == 0){  ?>
                                            <button type="button" class="btn btn-inverse-primary" data-bs-toggle="modal" data-bs-target="#exampleModal-4" data-whatever="@fat">Contacter le vendeur</button>
                                            <?php }else{
                                                $idc = $verif->fetch();
                                                ?>
                                            <a href="message.php?idc=<?= $idc["idc"]?>" class="btn btn-inverse-primary">Contacter le vendeur</a>
                                            <?php } ?>
                                        <?php else: ?>
                                            <a href="connexion.php" class="btn btn-inverse-primary">Contacter le vendeur</a>
                                        <?php endif; ?>
