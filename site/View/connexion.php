                        ...
                        <span class="input-group-text bg-transparent border-right-0">
                          <i class="mdi mdi-account-outline text-primary"></i>
                            ...
                            <div class="my-3 text-center">
                                <input type="submit" name="submit" class="btn btn-primary btn-lg btn-primary" value="Connexion">
                            </div>
                            <div class="text-center mt-4 font-weight-light"> Vous n'avez pas de compte ? <a href="inscription.php" class="text-primary">Inscrivez-vous</a> <!-- redirection vers la page inscription -->
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-lg-6 login-half-bg d-flex flex-row">
                    <p class="text-white font-weight-medium text-center flex-grow align-self-end">MBM &copy; projet MBM 2025.</p>
